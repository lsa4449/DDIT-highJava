	...
	public void start(Stage primaryStage) throws Exception {
		...
		ObservableList<MyFriend> list = 
				FXCollections.observableArrayList(
						...
						new MyFriend("a002", "박길동", "2222", "대구"),
						new MyFriend("a003", "이길동", "3333", "서울"),
						new MyFriend("a004", "서길동", "4444", "부산"),
						new MyFriend("a005", "윤길동", "5555", "울산"),
						new MyFriend("a006", "김길동", "6666", "청주")
						);
		combo.setItems(list);
		
		// ComboBox의 목록이 보여지는 곳의 내용 변경하기
		// 화면에 나타나는 셀의 내용을 변경하는 부분으로
		// 이 부분의 변경내용은 셀 부분만 변경된다.
...
//		});
		combo.valueProperty().addListener(new ChangeListener<MyFriend>() {
			...
			public void changed(ObservableValue<? extends MyFriend> observable, 
									MyFriend oldValue, MyFriend newValue) {
