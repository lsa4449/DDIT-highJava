...
public class T02_EnumTest {
	...
	// 데이터의 값을 정해줄 경우에는 생성자를 만들어서 괄호속의 값이 변수에 저장되도록
	// 해야한다.
	...
	public static void main(String[] args) {
		 ...
		 *  3. valueOf("열거형 상수 이름") => 지정된 열거형에서 "열거형사수이름"과
		 * 일치하는 열거형 상수를 반환한다.
		 */
		...
		// 열거형 객체변수에 값 저장하기
		myCity2 = City.서울; // City 타입의 서울
		myCity1 = City.valueOf("서울"); // City enum에서 '서울'인 객체 반환, String 값`
