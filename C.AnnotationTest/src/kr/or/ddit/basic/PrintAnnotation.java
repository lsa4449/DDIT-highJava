 ...
 * 정보를 제공함.
 * 
 * 종류 : 1. 표준에너테이션(주로 컴파일러에게 유용한 정보를 제공하기 위한 에너테이션)
 * 		2. 메타 에너테이션(에너테이션을 위한 에너테이션, 즉 에너테이션을 정의할 때
 * 		     			사용하는 에너테이션)
 * 에니테이션 타입 정의하기
 * @interface 에너테이션이름 {
...
@Retention(RetentionPolicy.RUNTIME) // annotation이 유지되는기간 (SOURCE, CLASS, RUNTIME)
